...
from model import FeedForwardNN_v1
...
config = {
    ...
    'n_epochs': 4,
    'batch_size': 128,
    'learning_rate': 1e-4, # use a different
    'dropout': 0.3,
    'weight_decay': 1e-2,
    'early_stop': 2,
    'hidden_layers': 3,
...
def main():
    ...
    fnn_model_v1 = FeedForwardNN_v1(INPUT_DIM, HIDDEN_DIM, OUTPUT_DIM, DROPOUT_RATE).to(device)
    model = fnn_model_v1
