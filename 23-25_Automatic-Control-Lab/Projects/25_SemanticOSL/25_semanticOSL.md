...
```latex
@article{monroy2018semantic,
  title={A semantic-based gas source localization with a mobile robot combining vision and chemical sensing},
  author={Monroy, Javier and Ruiz-Sarmiento, Jose-Raul and Moreno, Francisco-Angel and Melendez-Fernandez, Francisco and Galindo, Cipriano and Gonzalez-Jimenez, Javier},
  journal={Sensors},
  volume={18},
  number={12},
  pages={4174},
...
@article{anyfantis2021low,
  ...
  author={Anyfantis, Antonios and Silis, Athanasios and Blionas, Spyridon},
...
```latex
@inproceedings{erwich2024gsl,
  title={GSL-Bench: High Fidelity Gas Source Localization Benchmarking Tool},
  author={Erwich, Hajo H and Duisterhof, Bardienus P and de Croon, Guido CHE},
...
```latex
@article{jabeen2024odor,
  title={Odor source localization in outdoor building environments through distributed cooperative control of a fleetof UAVs},
  author={Jabeen, Meh and Meng, Qing-Hao and Hou, Hui-Rang and Li, Hong-Yue},
...
```latex
@inproceedings{he2024gas,
  title={Gas Source Localization for UAV Using Infotaxis-Based Three-Dimensional Algorithm and Particle Filtering},
  author={He, Duan and Lei, Cheng and Rong, Wang and Yu, Zhang},
...
```latex
@article{husnain2024gas,
  title={Gas concentration mapping and source localization for environmental monitoring through unmanned aerial systems using model-free reinforcement learning agents},
  author={Husnain, Anees ul and Mokhtar, Norrima and Mohamed Shah, Noraisyah Binti and Dahari, Mahidzal Bin and Azmi, Amirul Asyhraff and Iwahashi, Masahiro},
  journal={Plos one},
  volume={19},
  number={2},
  pages={e0296969},
...
@article{lewis2022configurable,
  ...
  author={Lewis, Tyrell and Bhaganagar, Kiran},
  journal={International Journal of Advanced Robotic Systems},
  volume={19},
  number={2},
  pages={17298806221081325},
  year={2022},
